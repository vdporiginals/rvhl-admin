...
@Component({
  selector: 'app-review-category-dialog',
  templateUrl: './review-category-dialog.component.html',
  styleUrls: ['./review-category-dialog.component.scss']
})
export class ReviewCategoryDialogComponent implements OnInit {
  detailForm: FormGroup;
  positions: any = [];
  isEdit = false;
  dataEdit: any;
  apiPath = 'user-reviews/category';
  constructor(
    private noti: NotificationService,
    private api: ApiService,
    private dialog: MatDialog,
    private dialogRef: MatDialogRef<ReviewCategoryDialogComponent>,
